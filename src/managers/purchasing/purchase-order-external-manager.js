...
module.exports = class PurchaseOrderExternalManager extends BaseManager {
    constructor(db, user) {
        super(db, user);
        this.collection = this.db.use(map.purchasing.PurchaseOrderExternal);
    ...
    _createIndexes() {
        var dateIndex = {
            name: `ix_${map.purchasing.PurchaseOrderExternal}_date`,
            key: {
                date: -1
            }
        }
        ...
        var noIndex = {
            name: `ix_${map.purchasing.PurchaseOrderExternal}_no`,
            key: {
                no: 1
            },
            unique: true

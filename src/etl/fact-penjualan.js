                            ...
                            var items = sale.items.map((item) => {
                                if (excludedBarcode.indexOf(item.item.code) == -1) {
                                    ...
                                    return {
                                        ...
                                        dt_category_name: `'${this.getDBValidString(item.item.categoryDoc ? item.item.categoryDoc.name : "")}'`,

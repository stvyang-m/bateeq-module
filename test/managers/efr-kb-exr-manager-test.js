...
before('#00. connect db', function(done) {
    helper.getDb()
        .then(db => {
            var PusatReturTokoKirimBarangReturSelesaiPerbaikanManager = require('../../src/managers/inventory/efr-kb-exr-manager');
            manager = new PusatReturTokoKirimBarangReturSelesaiPerbaikanManager(db, {
                username: 'unit-test'
            });
            done();
        })

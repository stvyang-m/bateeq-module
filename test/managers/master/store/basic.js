...
var Store = require("../../../data-util/master/store-manager-data-util");
var StoreManager = require("../../../../src/managers/master/store-manager");
var validate = require("bateeq-models").validator.master.store;
...
before("#00. connect db", function (done) {
    helper.getDb()
        .then((db) => {
            instanceManager = new StoreManager(db, {
                username: "unit-test"
            });
            done();
        })
    ...
    instanceManager.create({})
        ...
        .catch((e) => {
            try {
                ...
                e.errors.should.have.property("address");
                e.errors.should.have.property("phone");
                e.errors.should.have.property("salesCapital");
                done();
            }
            catch (ex) {
                done(e);

...
var validate = require('bateeq-models').validator.merchandisher;
var manager;

function getData() {
    var SpkDoc = require('bateeq-models').merchandisher.SPK;
    var SpkItem = require('bateeq-models').merchandisher.SPKItem;
    ...
    spkDoc.items.push(new SpkItem({ articleVariantId: "578855c4964302281454fa51", quantity: 1, remark: 'SPK PBR.test' }));
    return spkDoc;
}
...
before('#00. connect db', function (done) {
    helper.getDb()
        .then(db => {
            var SPKBarangJadiReturManager = require('../../src/managers/merchandisher/efr-pk-pbr-manager');

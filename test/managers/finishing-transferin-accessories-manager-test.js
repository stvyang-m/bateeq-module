...
it('#10. should error with sourceID is not 57738435e8a64fc532cd5bf1 (Aksesoris)', function(done) { 
   manager.create({sourceId:"57738460d53dae9234ae0ae1", destinationId:"57738460d53dae9234ae0ae1"})
        .then(id => { 
            done("Should not be error with sourceID is not 57738435e8a64fc532cd5bf1 (Aksesoris)");
        })
        .catch(e => { 
        try
        { 
...
it('#11. should error with destinationID is not 57738460d53dae9234ae0ae1 (Finishing)', function(done) { 
    manager.create({sourceId:"57738435e8a64fc532cd5bf1", destinationId:"57738435e8a64fc532cd5bf1"})
        .then(id => { 
            done("Should not be error with destinationId is not 57738460d53dae9234ae0ae1 (Finishing)");
        })
        .catch(e => { 
        try
        { 

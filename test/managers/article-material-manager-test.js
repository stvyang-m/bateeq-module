...
function getData() {
    var ArticleMaterial = require('bateeq-models').core.article.ArticleMaterial;
...
before('#00. connect db', function(done) {
    helper.getDb()
        .then(db => {
            var ArticleMaterialManager = require('../../src/managers/core/article/article-material-manager');

...
function getData() {
    var ArticleMaterial = require('bateeq-models').master.article.ArticleMaterial;
...
before('#00. connect db', function(done) {
    helper.getDb()
        .then(db => {
            var ArticleMaterialManager = require('../../src/managers/master/article/article-material-manager');

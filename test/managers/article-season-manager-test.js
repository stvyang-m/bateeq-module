...
function getData() {
    var ArticleSeason = require('bateeq-models').article.ArticleSeason;
    ...
    articleSeason.code = code;
    articleSeason.name = `name[${code}]`;
    articleSeason.description = `description for ${code}`;
...
before('#00. connect db', function(done) {
    helper.getDb()
        .then(db => {
            var ArticleSeasonManager = require('../../src/managers/article/article-season-manager');
